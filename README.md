...
|-----------------------------------------------------|----------|------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| initCycles                                          | X        | 10                                                                                                                           | The number of cycles to initialize for measuring the base load on the system.  <br/>_(Parameter is only used in JUnitExtension, not in JavaAgent)_                                                                                                                                          |
| samplingIntervalForInitInMs                         | X        | 1000                                                                                                                         | Polling interval for initialization phase.  <br/>_(Parameter is only used in JUnitExtension, not in JavaAgent)_                                                                                                                                                                             |
| calmDownIntervalInMs                                | X        | 1000                                                                                                                         | After initialization, the system waits until the test starts.  <br/>_(Parameter is only used in JUnitExtension, not in JavaAgent)_                                                                                                                                                          |
| percentageOfSamplesAtBeginningToDiscard             | X        | 15                                                                                                                           | What percentage of samples should be discarded at the beginning of the measurement to get more meaningful results. Meaningful: 5-20%.  <br/>_(Parameter is only used in JUnitExtension, not in JavaAgent)_                                                                                  |
| samplingIntervalInMs                                | X        | 300                                                                                                                          | Polling interval for test phase.  <br/>_(Parameter is only used in JUnitExtension, not in JavaAgent)_                                                                                                                                                                                                                                                           |   
| carbonDioxideEmissionFactor                         | X        | 485                                                                                                                          | Conversion factor to calculate approximated CO2 consumption in grams from energy consumption per kWh. Depends on the energy mix of your location, for germany compare e. g. https://www.umweltbundesamt.de/themen/klima-energie/energieversorgung/strom-waermeversorgung-in-zahlen#Strommix |
| measurement -> method                               |          | 'ohm'                                                                                                                        | Specify which measurement method to use. Possible values: ohm, csv                                                                                                                                                                                                                          |
| measurement -> csv                                  | X        | Configuration for reading from csv file. E.g. output from HWInfo                                                             |                                                                                                                                                                                                                                                                                             |
| measurement -> csv -> inputFile                     |          | 'hwinfo.csv'                                                                                                                 | Path to csv file to read measure values from                                                                                                                                                                                                                                                |
| measurement -> csv -> lineToRead                    | X        | 'last'                                                                                                                       | Which line in the csv input file contains the current measured values? The first or the last? This depends on the measurement tool. Possible value: first, last                                                                                                                             |
| measurement -> csv -> columns                       |          | Columns to read, index starts at 0.                                                                                          |                                                                                                                                                                                                                                                                                             |
| measurement -> csv -> columns -> index              |          | 95                                                                                                                           | Index from a sensor, index starts at 0.                                                                                                                                                                                                                                                     |
| measurement -> csv -> columns -> name               |          | 'CPU Package Power [W]'                                                                                                      | Name of a sensor                                                                                                                                                                                                                                                                            |
| measurement -> csv -> columns -> energyInIdleMode   | X        |                                                                                                                              | For the current measuring sensors the base load per sensor path can be configured (self-measured). If nothing is specified, then a base load measurement is performed in `@BeforeAll` (see also initCycles and samplingIntervalForInitInMs) and this value is used.                         |
| measurement -> csv -> encoding                      | X        | 'UTF-8'                                                                                                                      | Encoding to use for reading the csv input file                                                                                                                                                                                                                                              |
| measurement -> csv -> delimiter                     | X        | ','                                                                                                                          | Delimiter to use for separating the columns in the csv input file                                                                                                                                                                                                                           |
| measurement -> ohm                                  | X        | Configuration for reading from open hardware monitor                                                                         |                                                                                                                                                                                                                                                                                             |
| measurement -> ohm -> url                           |          | Url of the Open Hardware Monitor incl. port                                                                                  | (** started in administrator mode **)                                                                                                                                                                                                                                                       |
...
| measurement -> ohm -> paths -> energyInIdleMode     | X        |                                                                                                                              | For the current measuring sensors the base load per sensor path can be configured (self-measured). If nothing is specified, then a base load measurement is performed in `@BeforeAll` (see also initCycles and samplingIntervalForInitInMs) and this value is used.                         |
...
| javaAgent -> packageFilter                          | X        | 'group.msg', de.gillardon'                                                                                                   | Filter power and energy for methods starting with this packageFilter names, write results of filtered methods to separate CSV files.                                                                                                                                                        |
